GWSAndroidAppSamples
====================

Some android native java application samples.
...
Thanks goes to Nemi for viewdeocrator(my soft fork is GWSVeiwDecorator) and 
thanks goes to Flavio Faria for KenBurnsView, Andreas Stuetz for MaterialTabStrip, 
Soichiro Kashima for Android Observable ScrollView, and florent37, Inc. for MaterialViewPager.
